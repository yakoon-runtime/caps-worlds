...
async def main():
    ...
    ports.publish("worlds.world.service", worlds)
    ports.publish("worlds.box.service", boxes)
    ports.publish("worlds.endpoint.service", endpoints)
    ports.publish("worlds.connection.service", connections)
    ports.publish("worlds.note.service", notes)
    ports.publish("worlds.refine.service", refine)
